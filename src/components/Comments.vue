      ...
      <div class="hidden p-4 rounded-sm shadow cursor-pointer bg-background-secondary md:block grid-span-1">
            ...
            <div>
              ...
              <div class="flex items-center justify-between mt-2">
                ...
                <button
                  ...
                  @click="toggle"
                  type="button"
                  class="block text-sm text-blue-600 focus:outline-none"
                  aria-label="Menu"
                >
        ...
        >
          <div class="relative flex">
            <div class="hidden w-full p-4 mt-2 rounded-sm shadow cursor-pointer sm:mt-4 bg-background-secondary grid-span-3 md:block">
              <div class="h-full">
                  <p class="text-sm text-copy-secondary">В США проведут расследование крупнейших технологических компаний на возможное нарушение патентов</p>
